...
| `console/` | **Live web console** (on-brand, dark). `bash console/run.sh` on `nol8-demo`, tunnel `ssh -f -N -L 8770:localhost:8770 nol8-demo`, open a browser. Drives `/v1/process` live + shows the efficiency contrast. |
